...
class RainfallAgentAdapter(UnifiedDisturbanceAgent):
    """RainfallAgent适配器"""
    ...
    def __init__(self, agent_id: str, **kwargs):
        ...
        import warnings
        warnings.warn(
            "RainfallAgent is deprecated. Use UnifiedDisturbanceAgent with disturbance_type='rainfall' instead.",
            DeprecationWarning,
            stacklevel=2
        )

class WaterUseAgentAdapter(UnifiedDisturbanceAgent):
    """WaterUseAgent适配器"""
    ...
    def __init__(self, agent_id: str, **kwargs):
        ...
        import warnings
        warnings.warn(
            "WaterUseAgent is deprecated. Use UnifiedDisturbanceAgent with disturbance_type='water_use' instead.",
            DeprecationWarning,
            stacklevel=2
        )

class CsvReaderAgentDisturbanceAdapter(UnifiedDisturbanceAgent):
    """CsvReaderAgent扰动适配器"""
    ...
    def __init__(self, csv_file_path: str, time_column: str = 'time',
        ...
        agent_id = kwargs.get('agent_id', f'csv_disturbance_{Path(csv_file_path).stem}')
        super().__init__(agent_id, config)
        
        import warnings
        warnings.warn(
            "Using CsvReaderAgent for disturbances is deprecated. Use UnifiedDisturbanceAgent with disturbance_type='csv' instead.",
            DeprecationWarning,
            stacklevel=2
        )
